...
class Fuck:
	def __init__(self,type):
		...
		self.type=type
		if type=='土味情话':
			self.url='https://api.lovelive.tools/api/SweetNothings/WebSite'
			self.headers["path"]="/api/SweetNothings/WebSite"
			self.headers["authority"]="api.lovelive.tools"
			self.headers["referer"]="https://api.lovelive.tools/"
		elif type=='渣男语录':
